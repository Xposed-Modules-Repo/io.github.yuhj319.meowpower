...
- 包名：`io.github.yuhj319.meowpower`，当前版本 6.5
...
- 强制开启游戏插帧 / 超分（单开或双开），非支持机型/游戏也显示并下发
...
- 新增游戏后台豁免：切出去回消息，游戏不断连

### 6.4

- 新增游戏退出不复位：退游戏不再偷偷还原你的设置
...
- 新增强制游戏性能档：GameManager.setGameMode 一律写性能模式，不再看名单脸色

### 6.1

- 新增强制开启游戏插帧 / 超分：放行画质判定与按包支持，类型写死（1=插帧、2=超分、4=双开），初始化默认开
